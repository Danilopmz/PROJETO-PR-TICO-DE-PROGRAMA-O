...
<meta charset="utf-8">
    ...
    <title>HAX INFORMÁTICA - CADASTRO </title>
        ...
        <div class="hero-body">
            <div class="container has-text-centered">
                <div class="column is-4 is-offset-4">
                    <h3 class="title has-text-grey">HAX INFORMÁTICA - CADASTRE-SE</h3>
                
                    <div class="box">
                        <form action="cadastroscript.php" method="POST">
                            <div class="field">
                                <div class="control">
                                    <input name="nome" name="text" class="input is-large" placeholder="Seu nome" autofocus="" required>
                                </div>
                            </div>
                            <div class="field">
                                <div class="control">
                                    <input name="email" name="text" class="input is-large" placeholder="Seu e-mail" autofocus="" required>
                                </div>
                            </div>
                            <div class="field">
                                <div class="control">
